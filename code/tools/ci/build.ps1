...
if (!$DontUpload) {
    ...
    C:\cygwin64\bin\rsync -rvzhtu --chmod=D775,F664 --delete -e "C:\cygwin64\bin\ssh -o StrictHostKeyChecking=no -i $WorkRootDir\tools\ci\key.ppk" $BaseRoot/upload/ $env:SSH_TARGET
